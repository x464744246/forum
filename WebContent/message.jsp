...
<body>
	...
	<div class="container-fluid">
		...
		<ul class="pagination ">
			<li><a href="./Message_PageAction.action?page=1">&laquo;</a></li>
			<li><a href="./Message_PageAction.action?page=${page-2}">${page-2}</a></li>
			<li><a href="./Message_PageAction.action?page=${page-1}">${page-1}</a></li>
			<li><a href="./Message_PageAction.action?page=${page}">${page}</a></li>
			<li><a href="./Message_PageAction.action?page=${page+1}">${page+1}</a></li>
			<li><a href="./Message_PageAction.action?page=${page+2}">${page+2}</a></li>
			<li><a href="./Message_PageAction.action?page=-1">&raquo;</a></li>
		</ul>
		</nav>
	</div>
</body>
